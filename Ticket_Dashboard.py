...
tab_metrics, tab_problems, tab_cab, tab_dist = st.tabs(["📊 Metrics & List", "🚧 Problem Management", "👨‍⚖️ CAB Workbench", "📦 Distribution"])
...
with tab_dist:
    st.header("📦 Distribution Manager")
    st.info("**Project Portability**: Standardize and package your Mandrake environment for sharing or remote deployment.")
        ...
        if st.button("📦 Build Slim Distribution Zip", type="primary", use_container_width=True):
            with st.spinner("Building zip..."):
                try:
                    ...
                    cmd = [sys.executable, "build_distribution.py"]
